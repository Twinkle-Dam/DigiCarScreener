...
export const Carview = ({ latestCaptureData }) => {
  ...
  return (
    <div className="flex flex-col  p-4 rounded-lg font-manrope bg-white dark:bg-black-900  ">
      <Heading size="headinglg" as="h1" className="text-black dark:text-white-a700 mb-4">
        Active Patrol
