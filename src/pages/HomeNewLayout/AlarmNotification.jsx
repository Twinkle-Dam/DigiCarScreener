...
export const AlarmNotification = () => {
  ...
  return (
    <div className="p-4 flex flex-col gap-1 top-1 w-full h-full border border-solid dark:border-dark-600 rounded-lg bg-white-a700 dark:bg-dark-700 py-2">
      {/* Header Section */}
      <div className="mt-1 flex justify-between items-center">
        <div className="flex items-center gap-1">
          <h3 className="text-lg font-lato1 dark:text-white-a700">Alarms & Notifications</h3>
      ...
      <div className="relative flex-1 h-[250px] overflow-y-auto p-2 mt-2 max-h-[300px]">
        {carData.length > 0 ? (
